...
#
# I further modified this to include arguments on the callback function
#
...
class ToastNotifier(object):
    ...
    @staticmethod
    def _decorator(func, callback=None, arguments=None):
        """
        ...
        def inner(*args, **kwargs):
            kwargs.update({'callback': callback, 'arguments': arguments})
            func(*args, **kwargs)
        return inner

    def _show_toast(self, title, msg,
                    icon_path, duration, callback_on_click, arguments=None, text="Kemonotify"):
        ...
        self.wc.lpfnWndProc = self._decorator(self.wnd_proc, callback_on_click, arguments)  # could instead specify simple mapping
        try:
        ...
        nid = (self.hwnd, 0, flags, WM_USER + 20, hicon, text)
    ...
    def show_toast(self, title="Notification", msg="Here comes the message",
                    icon_path=None, duration=5, threaded=False, callback_on_click=None, arguments=None, text="Kemonotify"):
        """Notification settings.
        :title: notification title
        :msg: notification message
        :icon_path: path to the .ico file to custom notification
        ...
        if not threaded:
            ...
            self._thread = threading.Thread(target=self._show_toast, args=(title, msg, icon_path, duration, callback_on_click, arguments, text))
            self._thread.start()
        return True
    ...
    def wnd_proc(self, hwnd, msg, wparam, lparam, **kwargs):
        ...
        if lparam == PARAM_CLICKED:
            ...
            if kwargs.get('callback'):
                kwargs.pop('callback')(kwargs['arguments'])
