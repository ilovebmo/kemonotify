...
class ToastNotifier(object):
    ...
    def _show_toast(self, title, msg,
                    icon_path, duration, callback_on_click, arguments=None):
    ...
    def show_toast(self, title="Notification", msg="Here comes the message",
                    icon_path=None, duration=5, threaded=False, callback_on_click=None, arguments=None):
        """Notification settings.
        :title: notification title
        :msg: notification message
        :icon_path: path to the .ico file to custom notification
        ...
        if not threaded:
            ...
            self._thread = threading.Thread(target=self._show_toast, args=(title, msg, icon_path, duration, callback_on_click, arguments))
            self._thread.start()
        return True
